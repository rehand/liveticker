...
EVENT_TYPE_VAR_NO_GOAL = 'VAR KEIN TOR';
...
ALL_EVENT_TYPES = EVENT_TYPES.concat(EVENT_TYPE_SUBSTITUTION, EVENT_TYPE_PENALTY_GOAL, EVENT_TYPE_PENALTY, EVENT_TYPE_TEXT, EVENT_TYPE_COMMENT, EVENT_TYPE_VAR_NO_GOAL).concat(EVENT_TYPES_OVERTIME_PENALTY);
...
FORMATION_EXPORT_BACKGROUNDS = [{
    name: "3 Wechsel",
    url: "/images/background/BL_Aufstellungen.png", 
    maxIndex: 11 + 3 - 1,
    yPosLogo: 312,
    yPosFormationString: 350, 
    yPosText: 380, 
    yPosCoach: 1039
}, {
    name: "5 Wechsel",
    url: "/images/background/BL_Aufstellungen_5.png", 
    maxIndex: 11 + 5 - 1,
    yPosLogo: 268,
    yPosFormationString: 301, 
    yPosText: 315, 
    yPosCoach: 1076
}];
...
MAX_IMAGE_UPLOAD_WIDTH = 1920;
MAX_IMAGE_UPLOAD_HEIGHT = 1200;